...
public class TestGameController {
    ...
    //List<Player> players;
    class GameListenerForTesting implements GameListener{
    ...
    public void testConstruction(){
        ...
        gameController=null;
        try{
            gameController=new GameController(0,new ArrayList<>((Arrays.asList(new GameListenerForTesting(players.get(0)),new GameListenerForTesting(players.get(1))))));
