...
public interface GameListener {
    ...
    void updatePlayedCard(PlayerLobby player, CardPlayableIF cardPlayable, Coordinates coord);
     ...
     */
    void updatePickedCard(PlayerLobby player, List<CardPlayableIF> updatedVisibleCards);
